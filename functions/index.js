...
app.get("/hotels", (req, res) => {
  res.json([
    ...
    },
    {
      ...
      city: "Melbourne",
      description:
        "Guests at Oaks Melbourne Southbank Suites are within walking distance of Melbourne’s vibrant dining and shopping districts. These stylish modern apartments are air-conditioned and offer kitchen facilities.",
      image:
    ...
    },
    {
      ...
      city: "Melbourne",
      description:
        "Manly’s Hidden Gem offers accommodation in a heritage surrounding and is located nearby the attractions of Manly. The boutique hotel includes studios, 1 and 2-bedroom apartments all with an ensuite, kitchen and air-conditioning, or private guest rooms with a kitchenette and shared bathroom.",
      image:
    ...
    },
    {
      ...
      city: "Sydney",
      description:
        "Situated in the heart of the popular Darling Harbour entertainment district, Holiday Inn is ideally located for sightseeing, nightlife and shopping. A former 1890s wool store, this property boasts a free WiFi, a restaurant, a bar, a fitness centre, a spa pool and a sauna. Each of the air-conditioned rooms offers a desk and flat-screen TV.",
      image:
    ...
    },
    {
      ...
      city: "Perth",
      description:
        "Pan Pacific Perth is located in the Perth CBD, near the Swan River. Offering a large selection of guest rooms and suites, the hotel features an outdoor swimming pool and a 24-hour fitness centre. Parking is available for guests in the hotel carpark, at an additional charge.",
      image:
